...
<?php
	...
	class PosModelcategories extends JModelAdmin {
	
		public function getForm($data=array(),$loadData = true){
			$form=$this->loadForm ("com_pos.categories","categories");
	    ...
	    function getTotal()
	    {
	    	...
	    	$query = "SELECT COUNT(*) FROM category WHERE id>0";
	    ...
	    function remove()
	    {
	    	...
	    	$cache = JFactory::getCache('com_pos');
	    	$cache->clean();
	    	$mainframe->redirect('index.php?option=com_pos& view=categories', JText::_('K2_DELETE_COMPLETED'));
