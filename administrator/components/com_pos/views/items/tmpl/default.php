...
<body>	
	...
	<form name="adminForm" method="post" action="?option=com_pos&view=items">	
			<div >
				 <table >
					    <tr>
					      <td style="width:90%;">
					  ...
					  <table class="adminlist table table-striped">
					    <thead>
					      <tr>
					        ...
					        <th><?php echo JHTML::_('grid.sort', 'Tên món ăn', 'name', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
					        <th class="center"><?php echo JHTML::_('grid.sort', 'Mô tả', 'published', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
					    ...
					    <tbody>
					      ...
					      <tr class="row<?php echo ($key%2); ?>">
					        ...
					        <td class="k2Center center"><?php $row->checked_out = 0; echo JHTML::_('grid.checkedout', $row,$key,"item_id" ); ?></td>
					        <td><a href="<?php echo JRoute::_('index.php?option=com_pos&view=item &cid='.$row->item_id); ?>"><?php echo $row->name; ?></a></td>
