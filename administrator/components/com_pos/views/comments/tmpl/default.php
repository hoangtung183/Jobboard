...
<body>	
	...
	<form name="adminForm" method="post" action="index.php?option=com_pos &view=comments">	
			<div >
				 <table >
					    <tr>
					      <td style="width:90%;">
							...
							<button ><?php echo JText::_('Tìm lại'); ?></button>
					      </td>
					      <td >
					 ...
					 -->	<th class="center hidden-phone"><?php echo JText::_('Ngày tạo'); ?></th>
					        <th class="center hidden-phone"><?php echo JText::_('Ngày Update'); ?></th>
					    ...
					    <tbody>
					      ...
					      <tr class="row<?php echo ($key%2); ?>">
					        ...
					        <td class="k2Center center"><?php $row->checked_out = 0; echo JHTML::_('grid.checkedout', $row,$key,"comment_id" ); ?></td>
					        <td><a href="<?php echo JRoute::_('index.php?option=com_pos&view=comment &cid='.$row->comment_id); ?>"><?php echo $row->name; ?></a></td>
					       	<td> <?php echo $row->values ?>
