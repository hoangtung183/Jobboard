		...
		<fieldset class="adminform">
			...
			<table class="admintable table">
				...
				<tr>
					...
					<td><?php echo JHTML::_('calendar', $this->row->date_founding, 'date_founding', 'date_founding', $format = '%Y-%m-%d',array('class' => 'inputbox', 'size' => '20', 'maxlength' => '250')); ?>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="key"><?php echo JHTML::_('calendar', $this->row->create_date, 'create_date', 'create_date', $format = '%Y-%m-%d',array('class' => 'inputbox', 'size' => '20', 'maxlength' => '250')); ?>
					</td>
				</tr>
				<tr>
					<td colspan="2"> <?php echo $this->texts; ?>	</td>			
				</tr>
