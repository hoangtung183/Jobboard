			...
			<table class="adminlist table table-striped">
				<thead>
					<tr>
						...
						<th class="center hidden-phone"><?php echo JText::_('MATIEN'); ?></th>
						...
						<th class="center hidden-phone"><?php echo JText::_('NGAYKETTHUC'); ?>
						</th>
				...
				<?php foreach ($this->rows as $key => $row): ?>
					<tr class="row<?php echo ($key%2); ?>">
						...
						<td class="center hidden-phone"><a
							href="<?php echo JRoute::_('index.php?option=com_jobboard3i&view=currency&cid='.$row->id); ?>"><?php echo $row->name; ?>
						</a></td>
						<td class="center hidden-phone"><?php echo $row->code?>
						</td>
						...
						<td class="center hidden-phone"><?php echo $row->create_time?>
						</td>
						<td class="center hidden-phone"><?php echo $row->update_time?>
						</td>
						<td class="center hidden-phone"><?php echo $row->category_id?>
						</td>
