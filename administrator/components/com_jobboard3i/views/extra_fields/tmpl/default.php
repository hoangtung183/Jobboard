			...
			<table class="adminlist table table-striped" >
				<thead>
					<tr>
						...
						<th class="center hidden-phone"><?php echo JText::_('GIATRI'); ?></th>
						<th class="center"><?php echo JHTML::_('grid.sort', 'PUBLISHED', 'published', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
					 
					 	<th class="center hidden-phone"><?php echo JText::_('MA'); ?></th>
					 	<th class="center hidden-phone"><?php echo JText::_('TRANGTHAI'); ?></th>
				...
				<?php foreach ($this->rows as $key => $row): ?>
					<tr class="row<?php echo ($key%2); ?>">
						...
						<td class="center hidden-phone"><a
							href="<?php echo JRoute::_('index.php?option=com_jobboard3i&view=extra_field&cid='.$row->id); ?>"><?php echo $row->value; ?>
						</a></td>
