			...
			<table class="adminlist table table-striped">
				<thead>
					<tr>
						...
						<th class="center hidden-phone"><?php echo JText::_('NGAYTHANHLAP'); ?></th>
						<th class="center hidden-phone"><?php echo JText::_('TRUSOCHINH'); ?></th>
						<th class="center hidden-phone"><?php echo JText::_('DOANHTHUCONGTY'); ?></th>
						<th class="center hidden-phone"><?php echo JText::_('DIACHI'); ?></th>
				...
				<?php foreach ($this->rows as $key => $row): ?>
					<tr class="row<?php echo ($key%2); ?>">
						...
						<td class="center hidden-phone"><a
							href="<?php echo JRoute::_('index.php?option=com_jobboard3i&view=company&cid='.$row->id); ?>"><?php echo $row->name; ?>
						</a></td>
						<td class="center hidden-phone"><?php echo $row->date_founding?>
						</td>
						<td class="center hidden-phone"><?php echo $row->headquarters_city?>
						</td>
						<td class="center hidden-phone"><?php echo $row->revenue?>
						</td>
						<td class="center hidden-phone"><?php echo $row->address?>
						</td>
