...
<?php
	...
	class Jobboard3iModelCountries extends JModel {
		function getData(){
	        ...
	        $query = "SELECT * FROM #__jb_country";
	        $conditions = array();
	    ...
	    function getTotal()
	    {
	    	...
	    	$query = "SELECT COUNT(*) FROM #__jb_country WHERE id>0";
	    ...
	    function unpublish()
	    {
	    	...
	    	$cache->clean();
	    	$mainframe->redirect('index.php?option=com_pos&view=countries');
	    }
	    ...
	    function remove()
	    {
	    	...
	    	$cache->clean();
	    	$mainframe->redirect('index.php?option=com_jobboard3i&view=countries', JText::_('K2_DELETE_COMPLETED'));
