...
<?php
	...
	class Jobboard3iModelCurrencies extends JModel {
		function getData(){
	        ...
	        $query = "SELECT * FROM #__jb_currency";
	        $conditions = array();
	    ...
	    function getTotal()
	    {
	    	...
	    	$query = "SELECT COUNT(*) FROM #__jb_currency WHERE id>0";
	    ...
	    function unpublish()
	    {
	    	...
	    	$cache->clean();
	    	$mainframe->redirect('index.php?option=com_pos&view=currencies');
	    }
	    ...
	    function remove()
	    {
	    	...
	    	$cache->clean();
	    	$mainframe->redirect('index.php?option=com_jobboard3i&view=currencies', JText::_('K2_DELETE_COMPLETED'));
